...
void Joy::JoyCallback(const sensor_msgs::JoyConstPtr& msg) {
  ...
  std::cout << "axes_.roll: " << axes_.roll << "axes_.pitch " << axes_.pitch << std::endl;
  ...
  std::cout << "buttons l r e c t l: " << msg->buttons[buttons_.yaw_left] << " ; " << msg->buttons[buttons_.yaw_right] << " ; " << " ; " << msg->buttons[buttons_.ctrl_enable] << " ; " << msg->buttons[buttons_.ctrl_mode] << " ; " << msg->buttons[buttons_.takeoff] << " ; " << msg->buttons[buttons_.land] << std::endl;
